...
export const T = {
  fr: {
    ...
    recycle_sub: 'App Recycle! — dates de passage du camion',
    inbw_title: 'Mes poids réels (MonInBW)',
    inbw_sub: 'Kg enregistrés par inBW à chaque collecte',
    ...
    lbl_fb_email: 'E-mail de réponse',
  ...
  nl: {
    ...
    recycle_sub: 'Recycle! app — wanneer de vuilniswagen langskomt',
    inbw_title: 'Mijn werkelijke gewichten (MonInBW)',
    inbw_sub: 'Door inBW geregistreerde kg per ophaling',
    ...
    lbl_fb_email: 'E-mail voor antwoord',
  ...
  en: {
    ...
    recycle_sub: 'Recycle! app — when the truck comes',
    inbw_title: 'My actual weights (MonInBW)',
    inbw_sub: 'Kg recorded by inBW at each collection',
